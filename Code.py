...
root=Tk()
root.title("MasterMind by Witty_Coding")
root.geometry("500x500")
root.config(bg="light green")

def End(Case, Tried):
    Done=Label(root, text="COMPLETED IN "+str(Tried)+" TRIES!", bg="light green", font="ArielBold 15")
    Done.place(x=75, y=50)
    if Case == "y":
        Main.config(text="WELLDONE!")
    else:
...
def Compare(Try, Tried, Chosen, Answer):
    ...
    if Chosen[0]==Answer[0]:
        p1="Cor"
        L1=Label(root, text="1st Colour: CORRECT!", bg="light blue")
    elif Chosen[0] in Answer:
        p1="Alm"
        L1=Label(root, text="1st Colour: CORRECT Colour, WRONG Place", bg="yellow")
    else:
        p1="Wro"
    ...
    if Chosen[1]== Answer[1]:
        p2="Cor"
        L2=Label(root, text="2nd Colour: CORRECT!", bg="light blue")
    elif Chosen[1] in Answer:
        p2="Alm"
        L2=Label(root, text="2nd Colour: CORRECT Colour, WRONG Place", bg="yellow")
    else:
        p2="Wro"
        L2=Label(root, text="2nd Colour: WRONG!", bg="red")
        
    if Chosen[2] == Answer[2]:
        p3="Cor"
        L3=Label(root, text="3rd Colour: CORRECT!", bg="light blue")
    elif Chosen[2] in Answer:
        p3="Alm"
        L3=Label(root, text="3rd Colour: CORRECT Colour, WRONG Place", bg="yellow")
    else:
        p3="Wro"
        L3=Label(root, text="3rd Colour: WRONG!", bg="red")
        
    if Chosen[3] == Answer[3]:
        p4 = "Cor"
        L4=Label(root, text="4th Colour: CORRECT!", bg="light blue")
    elif Chosen[3] in Answer:
        p4="Alm"
        L4=Label(root, text="4th Colour: CORRECT Colour, WRONG Place", bg="yellow")
    else:
        p4="Wro"
        L4=Label(root, text="4th Colour: WRONG!", bg="red")
    L1.place(x=50, y=100)
    L2.place(x=50, y=150)
    L3.place(x=50, y=200)
    L4.place(x=50, y=250)
    def ret():
        ...
        if p1 == "Cor" and p2 =="Cor" and p3 == "Cor" and p4=="Cor":
            ...
            Start(Try, Tried+1)
    Cont= Button(root, text="Continue", height=5, width=13, command=ret)
...
Main=Label(root, text="CHOOSE YOUR DIFFICULTY!", font="ArielBold 15", bg="light green")
